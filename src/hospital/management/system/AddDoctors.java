...
public class AddDoctors extends JFrame{
    JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddDoctors(){
            ...
            JLabel AddPassengers = new JLabel("ADD DOCTORS DETAILS");
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/LG.jpg"));
            Image i3 = i1.getImage().getScaledInstance(500, 500,Image.SCALE_DEFAULT);
            ImageIcon i2 = new ImageIcon(i3);
            JLabel image = new JLabel(i2);
            image.setBounds(400,60,480,420);
            add(image);
            ...
            return;
                    ...
                    try {
                        Conn c = new Conn();
                        String str = "INSERT INTO DOCTORS values( '"+name+"', '"+gender+"', '"+age+"', '"+specialized+"', '"+reg_no+"', '"+salary+"', '"+phone+"', '"+email+"')";
                        
                        c.s.executeUpdate(str);
                        JOptionPane.showMessageDialog(null,"DOCTORS Added Successfully");
                        setVisible(false);
