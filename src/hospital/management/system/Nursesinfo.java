...
public class Nursesinfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Nursesinfo frame = new Nursesinfo();
	 ...
	 * @throws SQLException 
	 */
	public Nursesinfo() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    Conn c = new Conn();
				String displayCustomersql = "select * from NURSES";
		...
		lblJob = new JLabel("Gender");
		lblJob.setBounds(159, 11, 46, 14);
		contentPane.add(lblJob);
		
		
		
		lblDepartment = new JLabel("Specialized");
