...
public class Otherstuffinfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Otherstuffinfo frame = new Otherstuffinfo();
	 ...
	 * @throws SQLException 
	 */
	public Otherstuffinfo() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    Conn c = new Conn();
				String displayCustomersql = "select * from OTHER_STAFF";
