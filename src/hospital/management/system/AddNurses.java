...
import java.sql.*;
import javax.swing.*;
public class AddNurses extends JFrame{
    JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        ...
        public AddNurses(){
            ...
            JLabel Address = new JLabel("SPECIALIZED");
            Address.setFont(new Font("Tahoma", Font.PLAIN, 17));
            Address.setBounds(60, 170, 150, 27);
            add(Address);
			
            String course[] = {"Neurology","Surgery","Medicine","Dermatology","Opthalmology","Psychiatry","Urology","Pediatrics","Pathology"};
            ...
            JLabel AddPassengers = new JLabel("ADD NURSES DETAILS");
            ...
            ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/NURSES.jpg"));
            ...
            Next.addActionListener(new ActionListener(){
                public void actionPerformed(ActionEvent ae){
                    ...
                    String reg_no = textField_5.getText();
            ...
            return;
                    ...
                    if (reg_no.equals (""))
            {
            JOptionPane.showMessageDialog(null,"REGISTRATION should not be empty");
            return;
            }
                    if (email.equals (""))
            {
            ...
            return;
                    ...
                    String specialized = (String)c1.getSelectedItem();
                    
                    try {
                        Conn c = new Conn();
                        String str = "INSERT INTO NURSES values( '"+name+"', '"+gender+"', '"+age+"', '"+specialized+"', '"+reg_no+"', '"+salary+"', '"+phone+"', '"+email+"')";
                        
                        c.s.executeUpdate(str);
                        JOptionPane.showMessageDialog(null,"NURSES Added Successfully");
                        setVisible(false);
