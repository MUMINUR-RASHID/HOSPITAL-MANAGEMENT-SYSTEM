...
public class Officialstaffinfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Officialstaffinfo frame = new Officialstaffinfo();
	 ...
	 * @throws SQLException 
	 */
	public Officialstaffinfo() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    Conn c = new Conn();
				String displayCustomersql = "select * from OFFICIAL_STAFF";
