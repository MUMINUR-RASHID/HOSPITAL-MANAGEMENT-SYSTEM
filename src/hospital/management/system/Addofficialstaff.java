...
import java.sql.*;
import javax.swing.*;
public class Addofficialstaff extends JFrame{
    JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        JComboBox c1;

        public Addofficialstaff(){
            getContentPane().setForeground(Color.BLUE);
            getContentPane().setBackground(Color.WHITE);
            setTitle("ADD OFFICIAL STAFF DETAILS");
            ...
            String course[] = {"Receptionist","Pharmacist","Accountant","Manager"};
            ...
            JLabel AddPassengers = new JLabel("ADD OFFICIAL STAFF DETAILS");
            ...
            return;
                    ...
                    if (reg_no.equals (""))
            {
            JOptionPane.showMessageDialog(null,"ID NO should not be empty");
            return;
            }
                    if (email.equals (""))
            {
            ...
            return;
                    ...
                    try {
                        Conn c = new Conn();
                        String str = "INSERT INTO OFFICIAL_STAFF values( '"+name+"', '"+gender+"', '"+age+"', '"+specialized+"', '"+reg_no+"', '"+salary+"', '"+phone+"', '"+email+"')";
