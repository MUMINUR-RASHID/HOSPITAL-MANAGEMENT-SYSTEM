...
public class Updatecabine extends JFrame {
...
PreparedStatement pst = null;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Updatecabine frame = new Updatecabine();
	 ...
	 * @throws SQLException 
	 */
	public Updatecabine() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/cabin3.jfif"));
		...
		contentPane.add(lblNewLabel);
                ...
                try{
                    Conn c = new Conn();
                    ResultSet rs = c.s.executeQuery("select * from ADDMISSION");
                    while(rs.next()){
		...
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Conn c = new Conn();
                                ResultSet rs1 = c.s.executeQuery("select * from ADDMISSION where room = "+s1);
                            ...
                            try{
                                Conn c  = new Conn();
                                ResultSet rs2 = c.s.executeQuery("select * from CABINE where room = "+txt_Room.getText());
                                while(rs2.next()){
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) throws NumberFormatException {
				...
				try{
                                    Conn c = new Conn();
                                    String str = "update CABINE set status = '"+txt_Status.getText()+"' where room = "+txt_Room.getText();
