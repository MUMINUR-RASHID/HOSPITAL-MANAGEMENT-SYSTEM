...
public class Patiantinfo extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Patiantinfo frame = new Patiantinfo();
	 ...
	 * @throws SQLException 
	 */
	public Patiantinfo() throws SQLException {
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    Conn c = new Conn();
				String displayCustomersql = "select * from ADDMISSION";
		...
		lblNewLabel = new JLabel("Document");
		lblNewLabel.setBounds(31, 11, 66, 14);
