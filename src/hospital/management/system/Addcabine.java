...
import java.sql.*;
import java.util.*;
public class Addcabine extends JFrame implements ActionListener{
	...
	contentPane.setLayout(null);
        ...
        ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/CABINE.JFIF"));
        ...
        JLabel l10 = new JLabel("Cabine Book");
	...
	JLabel l4 = new JLabel("Price/Day");
	l4.setForeground(new Color(25, 25, 112));
	l4.setFont(new Font("Tahoma", Font.BOLD, 14));
	l4.setBounds(60, 190, 102, 22);
	contentPane.add(l4);
	...
	contentPane.add(t2);
        ...
        JLabel l5 = new JLabel("Cabine Type");
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                ...
                String str = "INSERT INTO CABINE values( '"+room+"', '"+type+"','"+available+"', '"+status+"','"+price+"' )";
