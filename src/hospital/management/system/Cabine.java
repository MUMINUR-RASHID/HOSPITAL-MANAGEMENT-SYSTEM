...
public class Cabine extends JFrame {
	...
	public Cabine() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon(ClassLoader.getSystemResource("icons/CABINE2.jpg"));
		...
		btnLoadData.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
                                    Conn c = new Conn();
					String displayCustomersql = "select * from CABINE";
		...
		lblCleanStatus = new JLabel("Availability");
		lblCleanStatus.setBounds(216, 15, 69, 14);
		contentPane.add(lblCleanStatus);
		
		lblNewLabel = new JLabel("Clean Status");
		lblNewLabel.setBounds(310, 15, 76, 14);
		contentPane.add(lblNewLabel);
		
		lblNewLabel_1 = new JLabel("Price");
		lblNewLabel_1.setBounds(417, 15, 69, 14);
