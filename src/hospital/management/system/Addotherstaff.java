...
import java.sql.*;
import javax.swing.*;
public class Addotherstaff extends JFrame{
    JTextField textField,textField_1,textField_2,textField_3,textField_4,textField_5,textField_6;
        JComboBox c1;

        public Addotherstaff(){
            getContentPane().setForeground(Color.BLUE);
            getContentPane().setBackground(Color.WHITE);
            setTitle("ADD OTHER STAFF DETAILS");
            ...
            String course[] = {"Guard","Cooker","Cleaner"};
            ...
            JLabel AddPassengers = new JLabel("ADD OTHER STAFF DETAILS");
            ...
            return;
                    ...
                    try {
                        Conn c = new Conn();
                        String str = "INSERT INTO OTHER_STAFF values( '"+name+"', '"+gender+"', '"+age+"', '"+specialized+"', '"+reg_no+"', '"+salary+"', '"+phone+"', '"+email+"')";
