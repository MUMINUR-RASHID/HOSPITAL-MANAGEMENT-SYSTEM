...
public class Reception extends JFrame {
	...
	public Reception(){
		...
		JButton btnNewCustomerForm = new JButton("Addmission Form");
		btnNewCustomerForm.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				Addpatiant custom = new Addpatiant();
		...
		JButton btnNewButton = new JButton("CABINE");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
				Cabine room = new Cabine();
		...
		contentPane.add(btnNewButton);
                ...
                JButton btnNewButton_2 = new JButton("DOCTORS INFO");
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				
					Doctorsinfo em = new Doctorsinfo();
					em.setVisible(true);
					setVisible(false);
		...
		contentPane.add(btnNewButton_2);
                ...
                JButton btnManagerInfo = new JButton("Nurses Info");
		btnManagerInfo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
				Nursesinfo mana = new Nursesinfo();
		...
		btnManagerInfo.setBounds(10, 150, 200, 30);
		...
		contentPane.add(btnManagerInfo);
                ...
                JButton btnNewButton_3 = new JButton("PATIANT INFO");
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					//error ---------------------
					Patiantinfo customer = new Patiantinfo();
		...
		JButton btnNewButton_1 = new JButton("OTHER STAFF");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					Otherstuffinfo dept = new Otherstuffinfo();
		...
		btnNewButton_1.setBounds(10, 230, 200, 30);
		...
		contentPane.add(btnNewButton_1);
                ...
                JButton btnSearchRoom = new JButton("OFFICIAL STAFF");
		btnSearchRoom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
				Officialstaffinfo search = new Officialstaffinfo();
		...
		btnSearchRoom.setBounds(10, 270, 200, 30);
		...
		JButton btnPickUpSerice = new JButton("DRIVERS");
		btnPickUpSerice.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
				Driverinfo pick = new Driverinfo();
		...
		JButton btnNewButton_6 = new JButton("Update Cabine Status");
		btnNewButton_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try{
					Updatecabine room = new Updatecabine();
					room.setVisible(true);
                                        setVisible(false);
				}catch(Exception s)
				{
		...
		btnNewButton_4.setBounds(10, 430, 200, 30);
